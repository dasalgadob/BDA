...
drop table if exists r;
	create  table r
(fecha varchar(3000), departamento varchar(45), municipio varchar(45),
 ...
 movil_victima varchar(45),  clase_empleado varchar(45),
...
begin 
	...
	movil_victima ,  clase_empleado from r limit 100 ;
    ...
    read_loop: LOOP
		...
		dia_VAL , hora_VAL , barrio_VAL,zona_VAL,
		clase_sitio_VAL, arma_empleada_VAL, movil_agresor_VAL,
		movil_victima_VAL,  clase_empleado_VAL;

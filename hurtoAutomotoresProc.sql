...
(fecha varchar(45), departamento varchar(45), municipio varchar(45),
 ...
 zona varchar(45),clase_sitio varchar(300), edad varchar(45) , sexo varchar(45),
 clase_bien varchar(45),marca varchar(45),linea varchar(45),modelo varchar(45),color varchar(45),
 arma_empleada varchar(45), movil_agresor varchar(45),
 movil_victima varchar(45),  estado_civil varchar(45),  profesion varchar(45), escolaridad varchar(45),
...
begin 
    ...
    clase_bien_VAL, marca_VAL, linea_VAL, modelo_VAL, color_VAL varchar(45) DEFAULT "";
	...
	movil_victima , edad , sexo ,
    clase_bien, marca, linea, modelo, color,
    estado_civil , profesion , escolaridad from r limit 100 ;
    ...
    read_loop: LOOP
		...
		dia_VAL , hora_VAL , barrio_VAL,zona_VAL,
		clase_sitio_VAL, arma_empleada_VAL, movil_agresor_VAL,
		movil_victima_VAL, edad_VAL, sexo_VAL,
        clase_bien_VAL, marca_VAL, linea_VAL, modelo_VAL, color_VAL,
        estado_civil_VAL,  profesion_VAL, escolaridad_VAL;
        ...
        INSERT INTO `dw_delitos`.`dim_objeto`
		(`clase`,`marca`,`linea`,`modelo`,`color`)
		VALUES
		(
		clase_bien_VAL,marca_VAL,linea_VAL,modelo_VAL,color_VAL);


        SET id_objeto_val = LAST_INSERT_ID();
        end;
